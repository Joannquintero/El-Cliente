        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Visits_Branchs_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availability_Branchs_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branchs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Availability_Products_ProductId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availability_BranchId",
                table: "Availability",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_Availability_ProductId1",
                table: "Availability",
                column: "ProductId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_Identifier",
                table: "Registrations",
                column: "Identifier",
                unique: true);
